...
# MY OG DSM METHOD + GRAD CONTRIBUTION (cumulative auc)
...
dsm_grad_cam_t_pos = [66.62, 33.26, 19.81, 8.74, 6.68, 6.17, 4.72, 4.55, 4.52]
dsm_grad_cam_t_neg = [66.62, 62.7, 55.17, 33.74, 22.95, 16.95, 5.5, 4.55, 4.52]
